...
library(RTutor)
check.problem.set('ECars', ps.dir, ps.file, user.name=user.name, reset=FALSE)
...
info("readRDS() and saveRDS()") # Run this line (Strg-Enter) to show info
...
info("group_by() and summarize()") # Run this line (Strg-Enter) to show info
...
#! addon__quiz__Damage Comparison
...
info("rename()") # Run this line (Strg-Enter) to show info

info("county_choropleth()") # Run this line (Strg-Enter) to show info
...
info("top_n() and arrange()") # Run this line (Strg-Enter) to show info
...
#! addon__quiz__Fahrenheit vs Celsius
...
#! addon__quiz__Coleto Creek

info("Base Load vs. Peaking") # Run this line (Strg-Enter) to show info
...
#! addon__quiz__AP2 model 1

#! addon__quiz__AP2 model 2

#! addon__quiz__AP2 model 3
...
ggplot(data = plotdat, aes(x = group, y = means)) +
  ...
  geom_jitter(data= dat, aes(x = group, y = value, colour=factor(urban)),
              shape = 1, width = .1, stroke=0, alpha=0.12) +
...
#! addon__quiz__Correlation Between Damages
...
info("Properties of the Gumbel distribution: Proofs") # Run this line (Strg-Enter) to show info
...
#! addon__quiz__US Average Purchase Subsidy
...
info("Using HtmlTable") # Run this line (Strg-Enter) to show info
